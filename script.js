...
const SYMBOL_CHAR = arrayFromLowToHigh(33, 47).concat(arrayFromLowToHigh(58, 64)
).concat(
...
form.addEventListener('submit', e => {
  ...
  const password = generatePassword(characterAmount, includeSpecialChars, includeNumbers, includeLowercase, includeUppercase)
  passwordDisplay.innerText = password
})

function generatePassword(characterAmount, includeSpecialChars, includeNumbers, includeLowercase, includeUppercase) {
